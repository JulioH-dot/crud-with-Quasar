    ...
    >
      ...
      <template v-slot:body-cell-actions="props">
        <q-td :props="props" class="q-gutter-sm">
          <q-btn color="accent" icon="edit" dense size="sm" @click="handleEditPost(props.row.id)"/>
          <q-btn color="negative" icon="delete" dense size="sm" @click="handleDeletePost(props.row.id)"/>
        </q-td>
      </template>'
  </q-table>
  </q-page>
